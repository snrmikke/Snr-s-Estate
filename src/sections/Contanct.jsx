...
const Contanct = () => {
  ...
  return(
    ...
    <div className={`${darkMode ? 'bg-black' : 'light bg-transparent'} pb-20`}>
      <section id="contact" className={`${darkMode ? 'dark bg-gray-800' : 'light bg-red-100'} lg:w-[95%] w-full h-fit m-auto rounded-xl grid lg:grid-cols-2 grid-cols-1 justify-centere items-center lg:px-36 px-6 py-20 gap-10`}>
        <div data-aos="zoom-in" className="bg-white dark:bg-black p-10 flex flex-col justify-center items-start gap-4 rounded-xl">
          ...
          <input type="number" placeholder="Enter your phone number" className="w-full px-6 py-3 border-2 border-gray-200 rounded-xl" />
        ...
        <div className="flex flex-col justify-center items-start gap-8 lg:p-20 p-6">
            <h1 data-aos data-aos-delay="200" className="text-red-500 dark:text-white">REACH US</h1>
            <h1 data-aos data-aos-delay="400" className="text-black text-[40px] font-semibold leading-10 dark:text-white">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repudiandae, aperiam?</h1>
            <p data-aos="zoom-in" data-aos-delay="500" className="test-xl text-gray-600 text-justify dark:text-white">Lorem ipsum dolor sit amet consectetur adipisicing elit. Totam exercitationem tempore rem laudantium soluta eos est! Corporis ratione deleniti illo!</p>
