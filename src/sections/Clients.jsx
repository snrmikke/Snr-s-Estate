  ...
  return (
    <div className={`${darkMode ? "dark bg-black" : "light bg-transparent"}`}>
      ...
      >
        ...
        <div
          id="clients-box"
          className="grid lg:grid-cols-3 grid-cols-1 justify-center items-center w-full gap-8"
        >
          {client.map((item, index) => (
            <div
              ...
              key={index}
              className="bg-white
            dark:bg-gray-900 hover:bg-red-100 cursor-pointer p-12 flex flex-col justify-center items-center gap-6 rounded-xl w-full"
            >
