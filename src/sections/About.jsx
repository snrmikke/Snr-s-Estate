...
<section id='about' className={`${darkMode ? 'dark bg-black' : 'light bg-transparent'} w-full m-auto lg:px-40 px-10 py-20 grid lg:grid-cols-2 grid-cols-1 justify-center items-center gap-10`}>
  ...
  <div className='flex flex-col justify-center items-start gap-8'>
    ...
    <h1 data-aos="zoom-in" data-aos-delay="200" className='text-black text-[400px: font-semibold leading-10 dark:text-white]'>Lorem ipsum dolor sit amet consectetur.</h1>
    <p data-aos="zoom-in" data-aos-delay="400" className='text-gray-600 dark:text-white text-justify'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi, ullam veritatis assumenda optio, odit debitis repellendus quidem nemo vero officiis excepturi quod dignissimos eligendi recusandae.</p>
